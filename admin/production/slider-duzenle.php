            ...
            <div class="tab-content p-3">
              <div class="tab-pane active" id="tab1">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                    <input class="form-control" name="slider_baslik" value="<?php echo $slidercek['slider_baslik'] ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                    <textarea class="form-control" name="slider_icerik" id="" cols="50" rows="4" placeholder="İçerik Girin"><?php echo $slidercek['slider_icerik'] ?></textarea>
                    </div>
                  </div>


                  <input type="hidden" name="slider_id" value="<?php echo $slidercek['slider_id']; ?>">
                  <button class="btn btn-primary" name="sliderduzenle" style="float: right;">Düzenle</button>
