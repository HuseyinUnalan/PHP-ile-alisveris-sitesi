              ...
              <div class="tab-pane active" id="tab1">
                ...
                <form action="../netting/islem.php" enctype="multipart/form-data" method="POST">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                      <input class="form-control" name="hizmet_ad" type="text">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                      <textarea  class="form-control" name="hizmet_icerik" type="text"></textarea>
                    </div>
                  </div>
                  ...
                  <button class="btn btn-primary" name="hizmetkaydet" style="float: right;">Kaydet</button>
