                ...
                <div class="tab-pane active" id="tab1">
                  ...
                  <form action="../netting/islem.php" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group row">
                      <label class="col-lg-3 col-form-label form-control-label">Kategoir Ad</label>
                      <div class="col-lg-9">
                        <input class="form-control" name="kategori_ad" type="text" placeholder="Kategoir Ad">
                      </div>
                    </div>
                    ...
                    <button class="btn btn-primary" name="kategorikaydet" style="float: right;">Kaydet</button>
