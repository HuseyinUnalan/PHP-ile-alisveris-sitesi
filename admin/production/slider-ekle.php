        ...
        <div class="card">
          <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-primary top-icon nav-justified">
              <li class="nav-item">
                <a href="javascript:void();" data-target="#tab1" data-toggle="pill" class="nav-link active"><i class="icon-note"></i> <span class="hidden-xs">Ekle</span></a>
              </li>
            ...
            <div class="tab-content p-3">
              <div class="tab-pane active" id="tab1">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                      <input class="form-control" name="slider_baslik">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    <label class="col-lg-3 col-form-label form-control-label">İçerik</label>
                    <div class="col-lg-9">
                      <textarea class="form-control" name="slider_icerik" id="" cols="50" rows="4" placeholder="İçerik Girin"></textarea>
                    </div>
                  </div>
                  ...
                  <button class="btn btn-primary" name="sliderkaydet" style="float: right;">Kaydet</button>
