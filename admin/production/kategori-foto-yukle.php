      ...
      <div class="card-body">
        ...
        <div class="tab-content p-3">
          <div class="tab-pane active" id="tab1">
            ...
            <a class="btn btn-success" href="kategori-galeri.php?kategori_id=<?php echo $_GET['kategori_id'];?>"><i class="fa fa-plus" aria-hidden="true"></i> Yüklenen Resimleri Gör</a>

            <form action="../netting/kategorigaleri.php" class="dropzone">
