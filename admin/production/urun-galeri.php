         ...
         <div class="card">
          <div class="card-body">
            ...
            <form action="../netting/islem.php" method="POST" enctype="multipart/form-data">
              ...
              <br>
              <a class="btn btn-success" href="urun-foto-yukle.php?urun_id=<?php echo $_GET['urun_id'];?>"><i class="fa fa-plus" aria-hidden="true"></i>  Fotoğraf Yükle</a>
              ...
              <div class="tab-content p-3">
                ...
                $urunfotosor->execute(array(
                  ...
                  <div class="tab-pane active" id="tab1">
                    ...
                    <img style="width: 300px; height: 200px; float: left; margin-right: 3px" src="../../<?php echo $urunfotocek['urunfoto_resimyol']; ?>" alt="image"/>
                    <hr>
                    <input type="checkbox" class="form-control"   name="urunfotosec[]"  value="<?php echo $urunfotocek['urunfoto_id']; ?>">
