     ...
     <div class="card">
      <div class="card-body">
        <ul class="nav nav-tabs nav-tabs-primary top-icon nav-justified">
          <li class="nav-item">
            <a href="javascript:void();" data-target="#tab1" data-toggle="pill" class="nav-link active"><i class="icon-note"></i> <span class="hidden-xs"> Fotoğraf Yükle</span></a>
          </li>
        ...
        <div class="tab-content p-3">
          <div class="tab-pane active" id="tab1">
            ...
            <a class="btn btn-success" href="hizmet-galeri.php?hizmet_id=<?php echo $_GET['hizmet_id'];?>"><i class="fa fa-plus" aria-hidden="true"></i> Yüklenen Resimleri Gör</a>

            <form action="../netting/hizmetgaleri.php" class="dropzone">
